...
document.addEventListener('visibilitychange',
    function () {
        if (document.visibilityState === "visible") {
            document.title = "Portfolio | Juliana Albuquerque";
            $("#favicon").attr("href", "js/euinicio.jpeg");
        } else {
...
var typed = new Typed(".escrever-texto", {
    strings: ["Desenvolvedora Front End", "Desenvolvedora Back end", "Desenvolvedora Full Stack"],
    loop: true,
    typeSpeed: 50,
    backSpeed: 25,
    backDelay: 500,
